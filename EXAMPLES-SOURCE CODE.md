...
# Example 5 Spring Batch Job Configuration
...
That completes the example for step configuration. 
...
That completes the example for configuring the database schema for Patient data. 
